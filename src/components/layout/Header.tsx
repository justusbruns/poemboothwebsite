          ...
          {mobileNavLinks.map((link) => {
            ...
            return isBook ? (
              <Link
                key={link.icon}
                href={link.href}
                className="flex flex-col items-center justify-center px-3 py-1.5 -mt-4 bg-text-primary text-bg-primary rounded-full shadow-lg min-w-[64px]"
              >
              ...
              <Link
                key={link.icon}
                href={link.href}
                className="flex flex-col items-center justify-center px-2 py-1.5 text-text-secondary hover:text-text-primary transition-colors"
              >
                {link.icon === "styles" && (
